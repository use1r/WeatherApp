...
import com.example.weatherapp.data.DefaultPreferences
import com.example.weatherapp.data.LocationPreferencesSerializer
...
object AppModule {
    ...
    ): com.example.weatherapp.domain.AppPreferences =
